          ...
          {(modalMode === 'create' || modalMode === 'edit') && (
            <div className="max-h-[70vh] overflow-y-auto pr-2 custom-scrollbar">
              <div className="mb-5">
                ...
                <div className="w-full h-32 border-2 border-dashed border-[#c64010]/30 rounded-xl bg-orange-50/50 flex flex-col items-center justify-center text-[#c64010] hover:bg-orange-50 transition-colors cursor-pointer">
              ...
              <div className="mb-5">
                ...
                <textarea 
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#c64010]/20 focus:border-[#c64010] resize-none text-gray-900 font-medium"
                ></textarea>
              </div>
              ...
              <div className="flex gap-4 mb-6">
                ...
                <div className="flex-1">
                  ...
                  <select 
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#c64010]/20 focus:border-[#c64010] bg-white text-gray-900 font-medium"
                  >
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl mb-8 border border-gray-100">
                ...
                <button 
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none ${formData.isActive ? 'bg-[#c64010]' : 'bg-gray-300'}`}
                >
