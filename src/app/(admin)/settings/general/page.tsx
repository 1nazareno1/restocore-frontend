      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.03)] p-8">
        ...
        <div className="flex justify-end mt-10 pt-6 border-t border-gray-50">
          <button 
            onClick={handleSave}
            disabled={isLoading}
            className="bg-brand text-white px-6 py-3 rounded-xl font-bold text-sm hover:bg-[#a8360d] transition-colors shadow-sm disabled:opacity-70 flex items-center gap-2"
          >
            {isLoading ? (
